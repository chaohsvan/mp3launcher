...
data class SettingsText(
    ...
    val globalVolumeKeyTrack: String,
    val globalVolumeKeyTrackDescription: String,
    ...
    companion object {
        val EN = SettingsText(
            ...
            accessibilitySettingsDescription = "Used to catch physical volume keys on the lock screen and, if enabled below, while another app is in front. It does not read screen content.",
            ...
            globalVolumeKeyTrack = "Use track keys in other apps",
            globalVolumeKeyTrackDescription = "When enabled, the <> track mode also maps volume keys to previous/next while another app is in front. Requires Accessibility access.",
            ...
            lcdSwipeTrack = "Simulated screen actions",
            lcdSwipeTrackDescription = "Swipe left or right on the simulated screen to switch tracks, or long-press the cover art to open the currently playing media app.",
            skin = "Skin",
        ...
        val ZH_CN = SettingsText(
            ...
            accessibilitySettingsDescription = "用途：在锁屏时捕获实体音量键；如果下方开关开启，也可在其他应用前台时切歌。不会读取屏幕内容。",
            ...
            globalVolumeKeyTrack = "在其他应用中也用音量键切歌",
            globalVolumeKeyTrackDescription = "开启后，<> 拨杆处于切歌模式时，其他应用前台也会把音量键映射为上一首/下一首。需要开启无障碍权限。",
            ...
            lcdSwipeTrack = "模拟屏幕操作",
            lcdSwipeTrackDescription = "在模拟屏幕上左右横滑切换上一首/下一首；长按封面可打开正在播放的媒体应用。",
            skin = "皮肤",
