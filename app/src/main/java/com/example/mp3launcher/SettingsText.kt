...
data class SettingsText(
    ...
    companion object {
        val EN = SettingsText(
            ...
            appGroupTagsDescription = "Manually place apps into Music, Social, Tools, or Games.",
            chooseGroup = "Choose group",
            autoGrouping = "Auto grouping",
            clearGroupOverrides = "Clear custom groups",
            clearGroupOverridesDescription = "Remove all manual app group tags and return to automatic grouping.",
        ...
        val ZH_CN = SettingsText(
            ...
            appGroupTags = "应用标签分组",
            appGroupTagsDescription = "手动把应用放入音乐、社交、工具或游戏分组。",
            chooseGroup = "选择分组",
            autoGrouping = "自动分组",
            clearGroupOverrides = "清除自定义分组",
            clearGroupOverridesDescription = "删除所有手动分组设置，恢复自动分类。",
            groupUpdated = "分组已更新",
            pinnedApps = "置顶应用",
            hiddenApps = "隐藏应用",
            noPinnedApps = "暂无置顶应用",
