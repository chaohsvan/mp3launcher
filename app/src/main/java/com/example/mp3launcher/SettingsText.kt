...
data class SettingsText(
    ...
    companion object {
        val EN = SettingsText(
            ...
            accessibilitySettingsDescription = "Used only to catch physical volume keys on the lock screen so MP3 Launcher can switch tracks. It does not read screen content.",
        ...
        val ZH_CN = SettingsText(
            ...
            accessibilitySettingsDescription = "用途：仅用于在锁屏时捕获实体音量键，让 MP3 Launcher 切换上一首/下一首；不会读取屏幕内容。",
